		...
		<>
			...
			>
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					d="M3.54492 7.64817C3.94042 6.77822 4.49929 6.01921 5.15462 5.33237C6.63755 3.77804 8.43307 2.78263 10.5585 2.44311C13.5333 1.96788 16.1958 2.66935 18.4966 4.65048C18.6419 4.77569 18.6779 4.84886 18.5198 5.00364C17.7077 5.79885 16.9085 6.60714 16.1045 7.41069C16.022 7.49308 15.9663 7.5937 15.8199 7.45943C13.7942 5.60345 10.4878 5.62459 8.33532 7.62635C7.59635 8.3136 7.07086 9.1372 6.72682 10.0813C6.67661 10.0484 6.62385 10.0191 6.57651 9.98267C5.56564 9.20501 4.55533 8.42646 3.54492 7.64817Z"
					fill="#D7282A"
				></path>
				<mask
					id="mask0_1356_2237"
				...
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					d="M6.70297 13.8719C5.64766 14.6912 4.59236 15.5106 3.53695 16.33C3.02157 15.3718 2.72429 14.3425 2.58561 13.2703C2.34531 11.4127 2.60935 9.6255 3.39738 7.92107C3.44066 7.82743 3.4955 7.73915 3.54492 7.64827C4.55533 8.42645 5.56564 9.205 6.57651 9.98266C6.62386 10.0191 6.67666 10.0484 6.72682 10.0813C6.30351 11.3423 6.3246 12.6059 6.70297 13.8719Z"
					fill="#F4C300"
				></path>
			</svg>
