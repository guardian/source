...
<Meta
	...
	parameters={{ previewTabs: { canvas: { hidden: true }}, viewMode: 'docs', chromatic: { disable: false } }}
/>
...
```css
font-family: 'GuardianTextSans, Guardian Text Sans Web, Helvetica Neue, Helvetica, Arial, Lucnamea Grande, sans-serif';
```
