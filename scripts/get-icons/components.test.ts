...
describe('The replaceStyleAttribute function', () => {
	...
	it('replaces multiple occurrences of style attribute with SVG attributes', () => {
		const source = `<svg
			viewBox="0 0 24 24"
