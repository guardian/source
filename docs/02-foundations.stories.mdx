...
> 💡 **CommonJS users:** Submodules under `@guardian/src-foundations` are exposed as ES Modules. If you require CommonJS modules, [see the FAQs](https://guardian.github.io/source/?path=/docs/docs-08-faqs--page) for solutions.
