...
Alternatively you can visit the folder for the component under the [`packages/@guardian` folder](https://github.com/guardian/source/tree/main/packages/%40guardian).
